...
public interface ResourceServiceFeignClient {
    ...
    String ROCKET_MERCHANT_CREATED_BROADCASTING_DESTINATION = SystemConstants.RABBIT_EXCHANGE_NAME + CacheProperties.DEFAULT_SEPARATOR + ROCKET_MERCHANT_CREATED_TAG;

    String ROCKET_MERCHANT_DELETED_BROADCASTING_DESTINATION = SystemConstants.RABBIT_EXCHANGE_NAME + CacheProperties.DEFAULT_SEPARATOR + ROCKET_MERCHANT_DELETED_TAG;
