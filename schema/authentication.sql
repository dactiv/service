...
-- ----------------------------
BEGIN;
INSERT INTO `tb_console_user` (`id`, `creation_time`, `version`, `email`, `password`, `status`, `username`, `gender`, `real_name`, `phone_number`, `groups_info`, `resource_map`, `last_authentication_time`, `remark`, `phone_number_verified`, `email_verified`) VALUES (1, '2021-08-18 09:40:46.953', 1, 'maurice.chen@foxmail.com', '$2a$10$U2787VFuFP9NMyxwdsP1bOmtvofTgwU5nLcdV7Gj3ZyhdiZO.T8mG', 1, 'admin', 10, '超级管理员', '18776974353', '[{\"id\": 1, \"name\": \"超级管理员\", \"status\": {\"name\": \"启用\", \"value\": 1}, \"authority\": \"ADMIN\"}]', '{}', '2024-01-26 15:31:46', '', NULL, NULL);
COMMIT;
